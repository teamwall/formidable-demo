...
(defn layout [opts & body]
  (page/html5
    ...
    #_"<script type=\"text/javascript\">goog.require('formidable_demo.main');</script>"))

(defn demo-header [active-tab]
  [:div.header
   [:h1 "Formidable Demo"]
   [:p "This is a demo of the "
    [:a {:href "https://github.com/teamwall/formidable"}
     "Formidable"]
    " library. Submit the form to see how the data gets validated and processed."]
   [:p [:a {:href "https://github.com/teamwall/formidable-demo"}
